  ...
  return (
    <html lang="en" className="dark">
      ...
      <body className="flex min-h-screen bg-slate-950 text-slate-100 selection:bg-blue-500 selection:text-white overflow-x-hidden">
        ...
        {/* Sidebar Lebih Ramping, Rapi, dan Kompak */}
        <motion.aside
        ...
        {/* Main Content dengan Margin Kiri Menyesuaikan secara Dinamis */}
        <motion.main
          animate={{ marginLeft: collapsed ? 72 : 240 }}
          transition={{ type: 'spring', stiffness: 300, damping: 30 }}
          className="min-h-screen flex-1 p-6 md:p-10 bg-slate-950 overflow-x-hidden w-full"
        >
          {children}
        </motion.main>
