...
def main():
    ...
    for _, row in df.iterrows():
        ...
        # 3. Update True Elo dan Antrean 5 Laga
        goal_diff = hg - ag
...
"""
    ...
    # 7. Simpan Model, Feature Columns, Profil Tim, dan model_metrics.json
    ...
    print(f"📁 Model, Profil {len(team_stats)} Tim, dan model_metrics.json BERHASIL disimpan!")
